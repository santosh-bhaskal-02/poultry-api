        ...
        public IActionResult GetDashboard()
        {
            try
            {
                ...
                return Ok(new
                {
                    ...
                    Data = new { TotalMortality = totalMortality, TotalAliveBirds = totalAliveBirds, TotalFeedConsume = totalFeedConsume, TotalFeedBags = totalFeedBags, TotalFeedBagsAvailable = totalFeedBagsAvailable }
                });
            }
            catch (Exception ex)
            {
